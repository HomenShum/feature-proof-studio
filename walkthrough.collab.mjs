...
const run = async () => {
    ...
    try {
      ...
      for (const op of spec.steps) {
        if (op.cap && op.burst) {
          ...
          steps.push({ caption: op.caption || op.cap, hold: op.hold || 78, burst: true, panes });
          ...
          steps.push({ caption: op.caption || op.cap, hold: op.hold || DEFAULT_HOLD, burst: false, panes });
  ...
  const data = "// AUTO-GENERATED by walkthrough.collab.mjs — do not edit by hand.\n" +
    "export const COLLAB_WALKTHROUGHS = " + JSON.stringify(out, null, 2) + ";\n";
